          ...
          {canWrite ? (
            ...
            <div className="rounded-2xl border border-court/30 bg-court/5 p-6 text-sm">
              ...
              <p className="mt-1 text-muted">
                매치 피드백은 승인된 GCM 팀 선수만 작성할 수 있습니다. 팀 소속·승인 여부는 코치에게 문의해 주세요.
              </p>
            </div>
          )}

          <div className="space-y-4">
            <h3 className="font-display text-base font-bold">내 매치 피드백 기록</h3>
            {analyses.length > 0 ? (
              analyses.map((a) => (
                <div key={a.id} className="rounded-2xl border border-line bg-base/40 p-5">
              ...
              <p className="rounded-2xl border border-line bg-base/40 px-5 py-8 text-center text-sm text-muted">
                아직 작성한 매치 피드백이 없습니다.
              </p>
            )}
          </div>
