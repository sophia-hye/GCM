...
const articles: { title: string; paragraphs: string[] }[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "② 회사는 회원가입 시 정보주체로부터 별도의 사전 동의를 받아 다음과 같이 개인정보를 제3자에게 제공합니다.",
      "· 제공받는 자 : Qure(큐어) [정식 사업자명 확인 필요]",
      "· 제공 목적 : Qure 서비스 내 회원 식별 및 개인 맞춤형 분석·서비스 제공 [문구 확인 필요]",
      "· 제공 항목 : 이름, 이메일, 전화번호, 성별, 생년월일",
      "· 보유·이용 기간 : 회원 탈퇴 시 또는 제공 목적 달성 시까지. 다만 관계 법령에 따라 보존이 필요한 경우 해당 기간까지 보관 [기간 확인 필요]",
      "③ 정보주체는 위 제3자 제공에 대한 동의를 거부할 권리가 있습니다. 다만 본 제공은 회원가입 및 서비스 제공에 필요한 사항으로, 동의를 거부하는 경우 회원가입이 제한될 수 있습니다.",
    ],
  },
  {
