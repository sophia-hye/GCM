    ...
    <div className="pt-16">
      <Section>
        <SectionHeading
          ...
          title={ko ? "성인 아마추어 클래스 신청" : "Adult Amateur Class Application"}
          lead={
            ko
              ? "용인 전술 트레이닝 프로그램(2026 4기) 신청서입니다. 항목을 입력해 주세요."
              : "Application form for the Yongin Tactical Training Program (2026 Season 4). Please fill in the fields below."
          }
        />
