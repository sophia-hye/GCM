...
export const KB_TEXT = {
  heroIntro: {
    ko: "전 세계 엘리트 집단이 자녀의 첫 스포츠로 테니스를 선택하는 이유. 단순한 소문이 아닌 학술적·의학적 근거로 정리해 드립니다.",
    en: "Why the world's elite choose tennis as their child's first sport — organized not as rumor, but with academic and medical evidence.",
  },
  evidTitle: { ko: "테니스가 아이에게 남기는 5가지", en: "5 things tennis gives a child" },
  evidLead: {
    ko: "집중력부터 성장, 멘탈, 사회성, 평생 건강까지 — 근거가 뒷받침하는 변화.",
    en: "From focus to growth, mental strength, social skills and lifelong health — changes backed by evidence.",
  },
  vipTitle: { ko: "GCM KIDS VIP 특별 혜택", en: "GCM KIDS VIP Special Offer" },
  vipDesc: {
    ko: "지금 바로 DM으로 ‘VIP 체험수업’을 신청해 보세요. 아이의 성향과 체형을 고려한 전담 코치진의 1:1 밀착 상담을 제공해 드립니다.",
    en: "Apply for a ‘VIP trial lesson’ by DM right now. Our dedicated coaches provide close 1:1 consultation tailored to your child's disposition and physique.",
  },
};

export const KIDS_REASONS: { title: Bi; sub: Bi; source: Bi; body: Bi }[] = [
  {
