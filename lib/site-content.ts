...
const enDirectorMessage = {
  ...
  homeSummary: [
    ...
    "Many parents, driven by a vague anxiety about the future, end up pushing their children. GCM Academy will carry that heavy burden for you. Admissions strategy, career worries and coaching are handled by our specialists — including veteran North American admissions officers — and together with specialized U.S. admissions institutions we prepare scholarship and university roadmaps from Plan A onward. At home, please give only warm love and encouragement.",
  ],
  before: [
    "Hello. I am Oh Seong-gook, Founder and Director of GCM Academy. To every parent and athlete who has found their way to us, thank you from the bottom of my heart.",
