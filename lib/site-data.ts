...
export const directorMessage = {
  ...
  homeSummary: [
    ...
    "테니스는 단순한 스포츠를 넘어, 인생을 살아가는 데 가장 강력한 자양분이 되어주는 위대한 교육이라 믿습니다. 목표가 뚜렷한 선수 공동체 안에서 아이들은 한계를 뛰어넘는 지구력과 투지, 승패 앞에서도 흔들리지 않는 프로의식과 멘탈, 그리고 스스로를 다스리는 절제력과 좋은 태도를 배웁니다. 코트 위에서 흘린 정직한 땀방울은 아이의 내면을 바르게 세우는 전인격적 교육의 밑거름이 됩니다.",
    "많은 학부모님께서 진로에 대한 막연한 불안 때문에 아이를 다그치게 되곤 합니다. 저희 GCM 아카데미는 그 무거운 불안을 대신 짊어지겠습니다. 입시 전략과 진로에 대한 고민, 코칭은 북미권 입학사정관 출신 베테랑을 비롯한 전문가들이 맡고, 미국 진학 전문 교육기관들과 함께 장학·진학 로드맵을 Plan A부터 세심하게 준비합니다. 부모님께서는 가정에서 따뜻한 사랑과 응원만 보내주시면 됩니다.",
  ],
  before: [
  ...
  quote:
    "하나의 가능성, 하나의 결과만으로 아이의 미래가 결정되는 것이 아니기에,\n배움이 아이들에게 압박이나 스트레스가 되지 않도록 조율합니다.",
  after: [
    ...
    "예상치 못한 부상이나 갑자기 진로를 전환하는 그 어떤 선택의 기로에서도, 저희의 든든한 파트너인 미국 전문 멘토링·입시 교육기관들이 함께합니다. 장학금을 받고 북미 명문대로 안전하게 진학할 수 있도록 Plan A부터 B, C, D, E까지 다양한 경우의 수를 세심하게 준비해 두었습니다. 아이들이 어떤 길을 걷더라도 주저앉지 않고 꿈을 펼칠 수 있도록, 견고한 지지대가 되어줄 것입니다.",
    ...
    "자녀를 향한 학부모님의 헌신이 최고의 결실로 이어질 수 있도록, 부모의 마음과 교육자의 사명감으로 함께하겠습니다. GCM 아카데미가 제안하는 안전하고 넓은 로드맵 위에서, 우리 아이들이 세계 무대에 당당히 설 기회는 이제 한국·이탈리아·상해로 이어지는 GCM 글로벌 네트워크를 통해 활짝 열려 있습니다.",
    "가족은 가족답게 서로 사랑하고, 미래는 전문가와 함께 편안하게 준비해 나가십시오.\n가장 신뢰할 수 있는 교육 파트너로서 늘 곁에서 든든하게 동행하겠습니다.\n감사합니다.",
  ],
};
...
export const consulting = {
  ...
  services: [
    { title: "진학 컨설팅", body: "UTR·실적 진단부터 타깃 대학·팀 선정, 하이라이트 영상과 코치 컨택까지 지원합니다." },
...
export const programs = [
  {
    ...
    desc: "처음 라켓을 잡는 단계로, 협동력과 리더십·인성·팀워크를 중심으로 즐거움과 재미를 느끼며 시작합니다.",
    points: [
      "협동력 · 팀워크 중심 그룹 훈련",
      "리더십 · 인성 교육",
      "기본기 · 코트 적응",
  ...
  },
  {
    ...
    duration: "장기 발전 경로",
    desc: "기본기부터 국제 대회까지, 엘리트 선수로 가는 장기 성장 로드맵을 설계합니다.",
    points: [
  ...
  },
  {
    ...
    target: "프로 지망 · 투어",
    duration: "주간 / 월간 / 풀 시즌",
    desc: "투어 무대와 실업팀 입단을 위한 고강도 퍼포먼스 매니지먼트를 제공합니다.",
    points: [
      "패턴 기반 훈련 · 매치 시나리오",
      "투어 스케줄 · 대회 동행 관리",
      "실업팀 계약 컨설팅",
...
export const whoWeAre = {
  title: "GCM은 어떤 곳인가",
  lead: "대표 오성국과 코치진들이 이끄는 고성능 테니스 아카데미.\n기술 · 피지컬 · 멘탈을 통합한 구조화된 훈련으로 선수의 장기 성장을 만듭니다.",
  pillars: [
    {
      en: "Mentality",
      title: "멘탈리티",
      body: "책임감과 투지, 회복력과 감정조절을 갖춘 선수로 성장하도록, 키즈 단계부터 인성과 팀워크 중심의 멘탈 케어를 함께합니다.",
    },
    {
      en: "Goal & Training",
      title: "목표설정 및 훈련",
      body: "고수준 훈련과 규율, 명확한 목표 설정으로 다음 단계를 준비합니다.",
    },
    {
      en: "Achievements",
      title: "성취",
      body: "과정 중심의 꾸준함과 지속적인 성과 검토로 성장을 증명합니다.",
    },
    {
      en: "Athletes",
      title: "선수 중심",
      body: "개인의 발전과 학업의 균형을 맞추며 장기적인 성장 경로를 설계합니다.",
    },
  ],
};
...
export const tracks = {
  ...
  a: {
    ...
    badge: "Primary Goal",
    body: "국내외 대회 및 투어 무대 경험을 통해 프로 데뷔 또는 실업팀 입단으로 연결합니다.",
  },
  b: {
    title: "Track B. 대학 테니스 선수",
    badge: "Pathway",
    body: "학업과 운동을 병행하며 대학 팀에서 선수 생활을 함께 이어갑니다.",
  },
