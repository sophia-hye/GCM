...
export const founding = {
  title: "GCM 설립 배경",
  lead: `"부모님의 과감했던 결단과 끝없는 신뢰가 사랑으로 기억되기에, 지금까지 지치지 않고 저와 같은 또 한 명의 선수를 위해 같은 마음의 교육자로서 이 자리에 설 수 있었습니다."`,
  paragraphs: [
    `저 역시 학창 시절, 정형화된 틀을 벗어나 '테니스'에 나의 최선을 다할 수 있도록 믿고 맡겨주신 부모님이 계셨습니다. 남들과 다른 길을 묵묵히 바라보며 끝까지 믿어주셨던 그 신뢰야말로, 제가 받은 가장 크고 따뜻한 사랑이었습니다. 그 깊은 사랑은 훗날 제가 힘든 순간마다 일어설 수 있는 평생의 가장 강력한 '삶의 원동력'이 되었습니다.`,
    `그 깊은 감사함은 한국 테니스를 향한 각별한 마음과 열정이 되었고, 이제는 우리 선수들에게 그 사랑을 되돌려주는 교육자로서의 사명이 되었습니다.`,
    `자녀에게 더 넓고 안전한 기회를 열어주고 싶어 하시는 학부모님들의 그 간절함, 그리고 '마음이 놓이는 결단'을 내리기까지 거치셨을 수많은 고민의 순간들을 누구보다 깊이 이해하고 헤아립니다. 누구보다 한마음으로 선수의 마음과 미래를 진심으로 응원하기 때문입니다.`,
    `미국, 이탈리아 등 국제 무대에서 활약할 기회는 여전히 유연하게 열려 있습니다. 그러나 제가 한국에 남아 이 자리를 지키는 이유는 분명합니다. 우리 아이들이 어린 나이에 부모님과 멀리 떨어지지 않고, 가정이 주는 따뜻한 사랑과 안정감을 듬뿍 받으며 대한민국에서도 마음껏 세계를 향해 도약할 수 있도록 그 길을 잇기 위함입니다.`,
    `이를 위해 GCM은 대한민국 선수로서, 또 GCM의 일원으로서 당당히 세계 무대에 도전할 수 있도록 [국내·국제 대회 출전 장학생]을 선발하여, SS스포츠진흥재단의 무한한 신뢰와 전폭적인 지원을 바탕으로 직접적인 도움을 드리고자 합니다. 저에게 닿았던 수많은 글로벌 기회들을 GCM으로 흘려보내, 선수들이 꿈을 향해 달릴 때 언제든 든든한 'Way Maker'가 되어드리겠습니다.`,
    `저희가 나눈 사랑과 헌신이 아이들에게 온전히 흘러가기를 바랍니다. 대한민국이라는 나라를 사랑하고, GCM에서 느낀 깊은 소속감이, 세계 어디를 향하든 한국 테니스를 향한 자부심과 함께 몸도 마음도 건강하게 성장하기를 소망합니다.`,
    `시련과 힘든 순간이 찾아오더라도 GCM의 동료 선수들과 동호인 분들께 받았던 뜨거운 사랑과 응원, 그리고 소중한 기회의 기억들이 또 다른 이에게 전해지는 예쁜 '이타심'으로 피어나길 기대합니다.`,
    `"나는 마음먹은 대로 무엇이든 할 수 있다."\n"나를 신뢰해 주는 이들 덕분에, 꼭 성공이 아니더라도 매 순간 성장하면 된다."`,
    `이 회복탄력성과 성숙함은 훗날 우리 아이들을 스스로 만족할 줄 아는 자긍심과 건강한 마음을 가진, 멋진 미래의 리더로 세울 것입니다. 어떤 승패 앞에서도 회복되는 '자기효능감'으로 가득 채워진 GCM 아이들의 멋진 성장기도 인스타그램과 웹사이트를 통해 곧 연재될 예정입니다.`,
    `상세한 내용은 댓글로 '기회' 또는 ❤️ 남겨주시면 신청 링크 전달 드리겠습니다.\n🎾 현역 프로의 최신 트렌드 전수: 코트 위에서 직접 체득한 세계 테니스 트렌드를 전합니다.\n💬 시차·국경 예외 없는 멘탈 코칭: 선수의 간절함을 깊이 이해하기에 끝까지 밀착 케어합니다. (※ 상담은 일정 조율을 위한 사전 예약 필수)\n🏆 국내·국제 대회 출전 장학 선수 선발: 한국에서도 글로벌 무대에 도전하도록 출전 기회를 지원해 드립니다.\n🗺️ 맞춤형 진학/유학 Plan A~Z 로드맵: 북미 입학사정관 및 글로벌 전문가와 함께 부상·진로 변경에도 흔들림 없는 미국 대학 리그, 장학금 유학, 국내외 대학 진학 솔루션을 제공합니다.`,
    `당장의 한두 번 결과로 아이의 미래가 결정되지 않는다는 것을 기억해 주세요. 아이가 안심하고 수용할 수 있는 현실적인 진로 선택지를 다양하게 제시해 드리겠습니다.`,
    `부모님께서는 가정에서 따뜻한 사랑과 응원만 보내주세요. 제가 그랬듯, "나를 끝까지 믿어준 부모님의 사랑"은 아이가 평생을 살아갈 가장 단단한 원동력이자 최고의 선물이 될 것입니다. 미래에 대한 고된 고민과 로드맵은 전문가인 저희 GCM 운영팀과 입시팀이 든든하게 지원하겠습니다.`,
    `전 세계 테니스 협력 기관의 성원에 힘입어, GCM은 더욱 넓은 세상까지 함께하겠습니다.`,
  ],
};
...
export const whoWeAre = {
  ...
  story: [
    "선수의 성장과 진로를 끝까지 책임지는 아카데미를 만들기 위해 GCM은 시작됐습니다.",
    "좋은 선수는 우연히 만들어지지 않습니다. 재능 있는 선수도 성장 경로가 없으면 정체됩니다. GCM은 선수의 현재 위치를 진단하고, 목표에 맞는 훈련과 대회, 멘탈 루틴, 진로 계획을 하나로 연결합니다. 우리는 선수를 단기 성과가 아니라 다음 단계로 성장시키는 과정으로 봅니다.",
