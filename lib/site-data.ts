...
export const founding = {
  ...
  paragraphs: [
    ...
    `이 회복탄력성과 성숙함은 훗날 우리 아이들을 스스로 만족할 줄 아는 자긍심과 건강한 마음을 가진, 멋진 미래의 리더로 세울 것입니다. 어떤 승패 앞에서도 회복되는 '자기효능감'으로 가득 채워진 GCM 아이들의 멋진 성장기도 인스타그램과 웹사이트를 통해 연재될 예정입니다.`,
...
export const scholarship = {
  title: "전액 · 부분 장학 신청",
  lead: "진정성 있는 성장을 위해 한정되어 마련된 특별한 장학 기회입니다. 바른 인성과 뜨거운 투지, 올바른 태도를 갖춘 선수가 성장할 수 있도록, GCM은 오늘도 그 도전을 기다립니다. 특별한 누군가의 이야기가 아닙니다. '나도 할 수 있다'는 용기와 목표를 향한 뜨거운 마음이 있다면 시작될 수 있습니다. 스탠포드 장학생의 뒤를 이어 새로운 가능성과 꿈에 도전해보세요!",
  points: [
    {
      title: "대상",
