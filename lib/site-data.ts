...
export const directorMessage = {
  ...
  homeSummary: [
    ...
    "많은 학부모님께서 진로에 대한 막연한 불안 때문에 아이를 다그치게 되곤 합니다. 저희 GCM 아카데미는 그 무거운 불안을 대신 짊어지겠습니다. 입시 전략과 진로에 대한 고민, 코칭은 북미권 입학사정관 출신 베테랑을 비롯한 전문가들이 맡고, 파트너 교육기관 이큐어(equre.us)와 함께 장학·진학 로드맵을 Plan A부터 세심하게 준비합니다. 부모님께서는 가정에서 따뜻한 사랑과 응원만 보내주시면 됩니다.",
  ],
  before: [
...
export const team = [
  ...
  },
  {
    name: "윤재원",
    role: "헤드 코치 · 기술 · 피지컬",
    bio: "기술 발달과 경기 운영, 일일 트레이닝과 매치 코칭 전반을 총괄하는 헤드 코치입니다.",
    image: "",
    achievements: [
      "前 고양시청 테니스 선수",
      "前 국군체육부대 테니스 선수",
