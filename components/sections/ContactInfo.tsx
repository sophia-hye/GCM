      ...
      <div className="mt-16 grid gap-x-10 gap-y-12 md:grid-cols-2">
        ...
        <div className="border-t border-line pt-6">
          ...
          <dl className="mt-6 space-y-4 text-sm">
            <div>
              <dt className="text-xs font-semibold uppercase tracking-[0.2em] text-court">전화</dt>
              <dd className="mt-1">
            ...
            <div>
              <dt className="text-xs font-semibold uppercase tracking-[0.2em] text-court">이메일</dt>
              <dd className="mt-1">
            ...
            <div>
              <dt className="text-xs font-semibold uppercase tracking-[0.2em] text-court">위치</dt>
              <dd className="mt-1 text-ink">{site.address}</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-[0.2em] text-court">운영 시간</dt>
